 ...
 * @version 1.0
 */
public class Player4MenuController implements Initializable {
	...
	public ComboBox<String> Player4Cmb;
	...
	private void onSelect1Press() {
		...
		Player4Cmb.getItems().remove(selectedPlayer1);
	...
	private void onSelect2Press() {
		...
		Player4Cmb.getItems().remove(selectedPlayer2);
	...
	private void onSelect3Press() {
		...
		Player4Cmb.getItems().remove(selectedPlayer3);
	 ...
	 * Choose an option from the combo box.
	 */
	private void onSelect4Press() {
		String selectedPlayer4 = Player4Cmb.getValue();
		getProfile(selectedPlayer4);
		Player1Cmb.getItems().remove(selectedPlayer4);
		Player2Cmb.getItems().remove(selectedPlayer4);
		Player3Cmb.getItems().remove(selectedPlayer4);
		System.out.println(selectedPlayer4);
		Player4Cmb.setDisable(true);
		selectPlayer4.setDisable(true);
	}
